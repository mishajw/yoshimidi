from yoshimidi.data.parse.midi_parsing import _shift_time_deltas
...
def test_shift_time_deltas() -> None:
    ...
    expected_notes: list[Note | KeySignature] = [
        Note(note=60, kind="on", velocity=100, time_delta_secs=0.0),
        Note(note=62, kind="off", velocity=0, time_delta_secs=0.1),
        Note(note=64, kind="on", velocity=100, time_delta_secs=0.2),
        Note(note=67, kind="off", velocity=0, time_delta_secs=0.3),
        Note(note=69, kind="on", velocity=100, time_delta_secs=0.4),
        Note(note=72, kind="off", velocity=0, time_delta_secs=0.5),
    ]
